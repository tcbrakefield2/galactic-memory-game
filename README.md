...
**Date:** <!-- add your submission date here -->

A space-themed card flip memory game built with vanilla JavaScript ES Modules, Bootstrap 5, and full WCAG AA accessibility. Match all pairs in as few moves as possible to complete your cosmic mission!

---

## 🎯 Game Objective

Reveal all matching pairs of cosmic symbol cards. The board is shuffled each round. Fewer moves = higher score. Beat your best!
...
![Wireframe of Cosmic Memory game UI](images/wireframe.svg)
...
**Live URL:** `https://YOUR_USERNAME.github.io/cosmic-memory/`

Replace `YOUR_USERNAME` in `index.html` footer links and the URLs above once deployed.
